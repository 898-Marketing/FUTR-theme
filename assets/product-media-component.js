  ...
  class ProductMedia extends HTMLElement {
    ...
    attachEventListeners() {
      ...
      window.eventBus.on('product:modal:close', (e) => {
        // Return if this is not a quick view modal
        if (!e.detail?.isQuickView) return;
      ...
      // Handle product media updated event
      window.eventBus.on('product:media:updated', (event) => {
        this.resetSlider();
      });
    }
